...
def parsing_data(filepath)
  ...
  return $cars = parsing_data['cars'], $rentals = parsing_data['rentals']
end
...
def book_a_car(filepath)
  ...
  $cars.each do |car|
    $rentals.select do |rental|
      rental_hash = booking_rental(car, rental) if rental['car_id'] == car['id']
